...
export function HeroSection() {
  return (
   ...
   <div>
  <AnimatedText
    text="Mohammed Iliyas Dokanwale"
    className="block text-4xl md:text-5xl font-bold tracking-tight"
  />
   <br />
  <AnimatedText
    text="Data Analyst"
    className="block text-2xl md:text-3xl font-semibold mt-1 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent"
    once={true}
  />
</div>
            ...
            >
             Data Analyst skilled in Excel, SQL, Python, Power BI, and Tableau, with experience in data cleaning, exploratory analysis, KPI design, and building insightful dashboards that support business decision-making.
            </ClientMotion>
            <ClientMotion
            ...
            >
              ...
              <Button variant="secondary" asChild className="relative overflow-hidden group">
                <Link href="/documents/iliyas_resume.pdf" target="_blank" download>
            ...
            >
              <Link
                href="http://linkedin.com/in/mohammediliyas"
                target="_blank"
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl">
              <Image src="/images/profile.jpeg" alt="Mohammed Iliyas Dokanwale" fill className="object-cover" priority />
